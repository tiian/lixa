...
extern "C" {
     ...
     * @param[in,out] buffer that's containing the serialized object
     *                  (it must be null terminated)
     * @param[out] buffer_len number of significative bytes of buffer
     ...
     * @param[in] cur pointer to XML subtree
     * @param[out] answer the object after deserialization
     * @return a reason code
     */
    ...
    /**
     * Deserialize an XML subtree containing details pertaining to
     * a message with verb=prepare, step=24
     * @param[in] cur pointer to XML subtree
     * @param[out] msg the object after deserialization
     * @return a reason code
     */
    int lixa_msg_deserialize_prepare_24(xmlNodePtr cur,
                                        struct lixa_msg_s *msg);


    /**
     * Deserialize an XML subtree containing details pertaining to
     * a message with verb=prepare, step=32
     * @param[in] cur pointer to XML subtree
     * @param[out] msg the object after deserialization
     * @return a reason code
     */
    int lixa_msg_deserialize_prepare_32(xmlNodePtr cur,
                                        struct lixa_msg_s *msg);
    ...
    /**
     * @brief Deserialize an XML subtree containing details pertaining to a
     * message with verb=scan, step=8
     * @param[in] cur pointer to XML subtree
     * @param[out] msg the object after deserialization
     * @return a reason code
     */
