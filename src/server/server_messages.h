...
/**
 * Associated to @ref srv_msg_body_thread_end_s
 */
#define SRV_MSG_TYPE_THREAD_END      5
...
/**
 * The thread is ending and notifies other threads what's happened
 */
struct srv_msg_body_thread_end_s {
    /**
     * Exception occurred in function @ref server_manager_thread
     */
    int   excp;
    /**
     * Return code of the function @ref server_manager_thread
     */
    int   ret_cod;
    /**
     * Last errno value generated by function @ref server_manager_thread
     */
    int   last_errno;
};
...
struct srv_msg_s {
    ...
    union {
        ...
        struct srv_msg_body_thread_end_s    te;
    } body;
};
