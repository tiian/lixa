...
int main(int argc, char *argv[])
{
    ...
    MYSQL                        *rm = NULL;
    /* constant for MySQL statement to execute */
    const char                   *mysql_stmt;
    /* constant for a second MySQL statement to execute */
    const char                   *mysql_stmt2;
    ...
    try {
         ...
         * subordinate Application Program has been called and this (superior)
